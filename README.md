...
项目灵感来自语言模型的自回归生成机制：$p(x_{n+1} \mid x_1, \ldots, x_n)$。改善提示词与输入文本的质量，能显著提升输出文本的质量。得益于 arXiv 等预印本平台公开的高质量大师 TeX 手稿，我们有机会从符号、语言和论证结构中提炼作者的个人风格，并将其作为写作指导应用于 AI 自动生成的证明，让读者获得更接近大师亲自讲解的阅读体验。
